...
class tai:
    ...
    def __init__(self, t2 = None):
        ...
        self.epoch = 4611686018427387904
        ...
        if t2:
            ...
            self.secs, self.nsec, self.asec = 0, 0, 0
    ...
    def from_unixtime(self, value):
        ...
        secs = value
        self.secs = self.epoch + secs

        # Account for sub-second values as floating-point
        subsec = value - secs
        assert(subsec < 1.0)
        self.nsec = subsec * 1000000000
    ...
    def _unpack_external(self, hex_str):
    ...
    def from_tai64na(self, s):
        ...
        self.secs = self._unpack_binary(secs)
        self.nsec = self._unpack_binary(usec)
        self.asec = self._unpack_binary(asec)
    ...
    def from_tai64n_ext(self, s):
        ...
        self.secs = self._unpack_external(secs)
        self.nsec = self._unpack_external(usec)
        self.asec = self._unpack_external(asec)
